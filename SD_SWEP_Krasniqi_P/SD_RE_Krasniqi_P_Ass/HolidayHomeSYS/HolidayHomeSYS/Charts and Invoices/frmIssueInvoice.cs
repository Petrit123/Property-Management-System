...
namespace HolidayHomeSYS
{
    public partial class frmIssueInvoice : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dtpArrDate.MaxDate = new System.DateTime(2018, 4, 26, 13, 52, 18, 0);
        ...
        private void cboBookid_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            booking.getBooking(Convert.ToInt16(cboBookid.Text.Substring(0, 5)));
            ...
            {
                booking.issueInvoice(Convert.ToInt32(cboBookid.Text.Substring(0, 5)));



                txtPropNo.Text = booking.getProp_No().ToString();
                txtSname.Text = booking.getSurname();
                txtFname.Text = booking.getForename();
                arrivalDate.Text = booking.getDateFrom().ToString();
        ...
        private void dtpArrDate_ValueChanged(object sender, EventArgs e)
        {
            ...
            ds = Bookings.getInvoice(ds, String.Format("{0:dd-MMM-yy}", dtpArrDate.Value));
